    ...
    <div className="flex min-h-screen justify-center">
      ...
      <main className="mt-36 flex w-2/3 flex-col justify-center gap-10 sm:mt-24 xl:mt-24">
        <section className=" flex flex-col justify-evenly gap-10 sm:mt-0 xl:flex-row">
          ...
          <article className="dark:border-outline min-h-64 overflow-auto rounded-lg border h-72 p-4 text-center dark:bg-transparent bg-black/40 scrollbar-thin scrollbar-track-transparent dark:scrollbar-thumb-indigo-800 scrollbar-thumb-black/70 scrollbar-thumb-rounded-full xl:w-full">
            <YourLinks urls={urls} />
          </article>
        </section>
        <section className="dark:border-outline flex self-center overflow-x-auto h-72 flex-col dark:bg-transparent bg-black/40 justify-evenly rounded-lg border p-4 text-center xl:w-1/3">
          <Contact />
        </section>
      </main>
      <Footer />
